...
async function enableOrganizationMfa() {
  try {
    // Connect to MongoDB
    ...
    // Enable organization MFA for all tenants
    ...
    console.log(`✅ Enabled organization MFA for ${result.modifiedCount} tenants`);

    // Verify the update
    const tenants = await Tenant.find({});
    console.log('\nTenants with organization MFA enabled:');
    ...
    console.log('\n✅ Organization MFA enabled successfully');
  } catch (error) {

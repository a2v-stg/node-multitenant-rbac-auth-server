...
// Test the tenant selection MFA flow
async function testTenantSelectionMfaFlow() {
  try {
    console.log('🧪 Testing Tenant Selection MFA Flow...\n');
    ...
    console.log('\n✅ Tenant Selection MFA Flow Test Completed!');
  } catch (error) {
